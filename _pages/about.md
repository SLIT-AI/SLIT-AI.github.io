...
* **Collaborations:** We maintain active collaborations with leading technology companies, including Meta, Alibaba, Tencent, WeChat, and Meituan.

[<i class="fab fa-github"></i> View FuseLLM on GitHub](https://github.com/fanqiwan/FuseLLM){: .btn .btn--info} [<i class="ai ai-google-scholar"></i> Google Scholar](https://scholar.google.com/citations?user=dRpg4t8AAAAJ&hl=en){: .btn .btn--primary}
...
* **Visiting Scholar**, Rutgers Business School, Rutgers University (2010.06 – 2010.08)
...
* **Guangdong Pearl River Recruitment Program of Talents**: Innovative R&D Team on Mobile Converged Computing (Key Leading Member, 2018–2023).
* **Industry Grants**: Funded by **WeChat**, **Meituan**, **China Mobile**, **Alibaba**, **Tencent**, **Vipshop**, etc.
